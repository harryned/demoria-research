...
/* 3 — Complete: pillars + tall chart + 6 key stats, drop context/note */
...
body.cp3 .cp-h{margin:13px 0 7px!important}
body.cp3 .pbar{margin:4px 0!important}
body.cp3 .pbar .pt{height:6px!important}
body.cp3 #cp-traj{flex:1 1 0!important;min-height:100px!important;height:auto!important;align-self:stretch}
body.cp3 .cp-stat{padding:7px 11px!important}
body.cp3 .cp-stat .sv{font-size:.92rem!important}
body.cp3 .cp-h-ctx, body.cp3 #cp-ctx, body.cp3 #cp-note{display:none!important}
body.cp3 #cp-full{margin:12px 0 4px!important;padding:11px!important;font-size:.86rem!important}
