...
.wrap{max-width:1180px;margin:0 auto;padding:16px 22px 30px}
...
.sub{max-width:790px;margin:0 auto 12px;text-align:center;color:var(--mut);font-size:.92rem;line-height:1.45}
...
function layout(){
  W=stage.clientWidth;
  const ctlEl=document.querySelector('.ctl'), footEl=document.querySelector('.foot');
